...
// In Vercel, the database file will be ephemeral. 
// For production, use a hosted database like Neon (Postgres) or Turso (SQLite).
const dbPath = process.env.NODE_ENV === "production" ? "/tmp/sports_stock.db" : "sports_stock.db";
